...
echo -e ""
echo -e "${YELLOW}${BOLD}Glöm inte:${NC}"
echo -e "  • Styrkortet ska matas via strömplinten (GND / 7–60 V) – USB/ST-Link räcker inte för CAN."
echo -e "  • På ett NYTT styrkort är inställningarna tomma: fyll i motorerna i RControlStation"
echo -e "    (fliken Confcommon, t.ex. VESC 28/36 = Speed Control, 76 = Steering Control) och tryck Write."
echo -e "    Senare flashningar behåller inställningarna."
echo -e ""
